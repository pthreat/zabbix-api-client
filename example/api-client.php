...
try {
    ...
    /**
     * Determine which hosts have the lowest RAM + CPU usage, this is useful when you want to, for example, load balance
     * some jobs through a work queue in different servers, in this case, we obtain a list of hosts sorted by most idle first.
     */
    ...
    /**
     * Same as above, except only the IP address of the most idle host will be returned.
     */
